...
if len(sys.argv) != 3:
    ...
    print("2. Save file.")
    print("*** USAGE ***")
    print("Ex : python combine_text.py (file to read).txt (name the file to save).txt") # For terminal on Mac or Windows
    print("             ------------ OR ------------ ")
    print("Ex : python combine_text.py $(file to read).txt $(name the file to save).txt") # on linux
    exit()
